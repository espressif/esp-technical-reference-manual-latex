...
\label{fielddesc:MSELECT}\item [mselect] 配置是否使用 \hyperref[fielddesc:MVALUE]{mvalue} 中的数据来匹配 mcontext 的值。\\
0：忽略 \hyperref[fielddesc:MVALUE]{mvalue}\\
1：仅当 mcontext 的低位等于 \hyperref[fielddesc:MVALUE]{mvalue} 时，此触发器才会匹配。\\
(R/W)
