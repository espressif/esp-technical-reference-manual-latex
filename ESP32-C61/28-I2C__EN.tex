...
\begin{equation*}
\label{fielddesc:I2CSCLKDIVNUM}I2C\_SCLK\_DIV\_NUM + 1+\frac{ I2C\_SCLK\_DIV\_B}{I2C\_SCLK\_DIV\_A}
\end{equation*}

In the formula, I2C\_SCLK\_DIV\_NUM represents the integer part of the divisor, I2C\_SCLK\_DIV\_A represents the denominator of the fractional part of the divisor, and I2C\_SCLK\_DIV\_B represents the numerator of the fractional part of the divisor. Limited by timing parameters, the derived clock I2C\_SCLK should operate at a frequency 20 times larger than SCL's frequency.\\
