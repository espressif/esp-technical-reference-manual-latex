...
{\bfseries \chipname{} \tagged{ESP32-P4, ESP32-P4-latest}{\GetTranslation{chiprevision}} \GetTranslation{doctype}}面向使用 \chipname{} 系列产品进行底层软件开发的人员，介绍了 \chipname{} 系列产品中内置的硬件模块，包括概述、功能列表、硬件架构、编程指南、寄存器列表等信息。
