...
\phantomsection
\subsection*{Abbreviations Related to Registers}\label{glossary-abbr-reg}
...
\clearpage
\phantomsection
\subsection*{Access Types for Registers}\label{glossary-access-types}
...
W1 & \textbf{Write Once.}
	User application can write to this register/field only once; only allowed to write 1; writing 0 is invalid. \\
