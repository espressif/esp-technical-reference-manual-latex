...
\begin{itemize}
    ...
    \end{itemize}
    \item Use the native \textbf{Navigation} function of your PDF viewer to navigate through the documents. Most PDF viewers support to go \textbf{Up}, \textbf{Down}, \textbf{Previous}, \textbf{Next}, \textbf{Back}, \textbf{Forward} and \textbf{Page} with buttons, menu, or hot keys.
