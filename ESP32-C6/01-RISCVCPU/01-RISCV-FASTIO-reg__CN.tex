...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIO_IN}\item [CPU\_GPIO\_IN] 表示 SoC GPIOn (n=0 \verb+~+ 21) 的输入值（1 为高电平，0 为低电平）。\\
