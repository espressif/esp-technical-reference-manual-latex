...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\item [AES\_TRIGGER] Configures whether or not to start AES operation. \\
0: No effect\\
1: Start\\
(WO)
\end{reglist}\end{regdesc}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\item [AES\_DMA\_EXIT] Configures whether or not to exit AES operation. \\
0: No effect\\
1: Exit\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\item [AES\_INT\_CLEAR] Configures whether or not to clear AES interrupt. \\
0: No effect \\
1: Clear \\
(WO)
\end{reglist}\end{regdesc}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\item [AES\_INT\_ENA] Configures whether or not to enable AES interrupt.\\
0: Disable\\
1: Enable \\
(R/W)
\end{reglist}\end{regdesc}
