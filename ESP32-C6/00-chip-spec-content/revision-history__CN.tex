...
\begin{longtable}[l]{ | m{2cm} | m{1.5cm} | m{12cm} | }\hline
    ...
    更新以下章节：
    \begin{itemize}
        \item 章节 \ref{mod:sysmem} \textit{\nameref{mod:sysmem}}：更新表 \ref{tab:sysmem-base-address}，新增 Cache 地址范围，并更正 INTPRI 之后的保留区间 %DOC-15596
        \item 章节 \ref{mod:bootctrl} \textit{\nameref{mod:bootctrl}}：更新系统启动模式表，新增无效 Strapping 组合 % DOC-14953
        \item 章节 \ref{mod:lowpowm} \textit{\nameref{mod:lowpowm}}：更新表 \ref{tab:lowpowm-wakeup-source}，Wi-Fi beacon 不可作为 Deep-sleep 的唤醒源 %DOC-15830
