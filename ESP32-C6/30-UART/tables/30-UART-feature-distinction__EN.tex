...
128 x 8 bit RAM respectively for the TX channel and RX channel of a UART controller & 32 x 8-bit RAM respectively for the TX channel and RX channel of LP\_UART \\ \hline
...
\multicolumn{2}{|c|}{UART as wake-up source} \\ \hline
\multicolumn{2}{|c|}{Software and hardware flow control} \\ \hline
\makecell[l]{Three prescalable clock sources\\1. APB\_CLK\\ 2. XTAL\_CLK\\ 3. RC\_FAST\_CLK} & \makecell[l]{Two prescalable clock sources\\1. XTAL\_D2\_CLK\\ 2. LP\_FAST\_CLK} \\ \hline
\end{longtable}