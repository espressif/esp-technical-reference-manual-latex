...
\caption{BLOCK0 参数}
    ...
    \hline
    \hyperref[fielddesc:EFUSESWAPUARTSDIOEN]{EFUSE\_SWAP\_UART\_SDIO\_EN}  &  1 & Y & 2  &  表示是否交换 UART 和 SDIO 模块的管脚\\
    \hline
    ...
    \hyperref[fielddesc:EFUSESECUREBOOTDISABLEFASTWAKE]{EFUSE\_SECURE\_BOOT\_DISABLE\_FAST\_WAKE} & 1 & N & 19 & 表示当 Secure Boot 开启时是否关闭 "fast verify on wake"\\\hline    
\end{longtable}
