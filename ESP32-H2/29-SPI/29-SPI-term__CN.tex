...
\textbf{CPU 控制的传输}& 由 CPU 控制，\hyperref[regdesc:SPIW0REG]{SPI\_W0\_REG} \verb+~+ \hyperref[regdesc:SPIW0REG]{SPI\_W15\_REG} 与 SPI 设备之间的数据传输。\\
...
\textbf{Quad I/O Read} & Quad SPI 的另一种数据模式，一个时钟周期可传输一位命令、或四位地址、或四位数据。\\
