...
The SHA accelerator is activated by setting the \hyperref[fielddesc:PCRSHACLKEN]{PCR\_SHA\_CLK\_EN} bit and clearing the \hyperref[fielddesc:PCRSHARSTEN]{PCR\_SHA\_RST\_EN} bit in the \hyperref[regdesc:PCRSHACONFREG]{PCR\_SHA\_CONF\_REG} register. Additionally, users also need to clear \hyperref[fielddesc:PCRDSRSTEN]{PCR\_DS\_RST\_EN}, \hyperref[fielddesc:PCRHMACRSTEN]{PCR\_HMAC\_RST\_EN}, and \hyperref[fielddesc:PCRECDSARSTEN]{PCR\_ECDSA\_RST\_EN} bits to reset \nameref{mod:digsig}, \nameref{mod:hmac}, and \nameref{mod:ecdsa}.
...
\begin{itemize}
    \item To enable this function: write 1 to register \hyperref[regdesc:SHAINTENAREG]{SHA\_INT\_ENA\_REG}.
    \item Note that the interrupt should be cleared by software after use via setting the \hyperref[regdesc:SHAINTCLEARREG]{SHA\_INT\_CLEAR\_REG} register to 1.
\end{itemize}
...
\subfile{\modulefiles/23-SHA-reg-summ__EN}
...
\subfile{\modulefiles/23-SHA-reg__EN}
