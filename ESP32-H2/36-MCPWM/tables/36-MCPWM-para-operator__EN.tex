...
\endfoot
    ...
    \begin{itemize}
        \item Configure the PWM duty cycle for PWM\textcolor{red}{\it{x}}A and/or PWM\textcolor{red}{\it{x}}B output
        \item Configure at which time the timing events occur
        \item Configure what action should be taken on timing events:
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Configure the duration of the first pulse in the carrier waveform
        \item Configure the duty cycle of the following pulses
    ...
    \begin{itemize} \vspace{-1em}   
        ...
        \item Configure an option for cycle-by-cycle actions clearing
        \item If desired, independently-configured actions can be taken when the time-base counter is counting down or up.\vspace{-1em}
