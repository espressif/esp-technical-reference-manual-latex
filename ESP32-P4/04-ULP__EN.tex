...
After a reset, the core starts to fetch instructions from the memory address specified by the \hyperref[regdesc:LPSYSTEMLPCOREBOOTADDRREG]{LP\_SYSTEM\_LP\_CORE\_BOOT\_ADDR\_REG} register with an offset of 0x80. The default value for this register is 0x50100000, which corresponds to the starting address of the LP ROM.
