...
\begin{longtable}[c]{|c|c|c|L{9cm}|}
    ...
    \multicolumn{3}{|c|}{sat} & 1-bit immediate value. Enables or disables saturation for the instruction result. \\\hline
    \multicolumn{3}{|c|}{rm} & 3-bit immediate value ranging from 0 to 7. Selects the rounding mode for right-shift operations. Value 7 (DYNAMIC) uses \texttt{vxrm} from the CFG register. \\\hline
