...
\begin{itemize}
    ...
    If this eFuse is 0 (default), software can force switch the chip from SPI Boot mode to Joint Download Boot mode by setting register \hyperref[fielddesc:LPSYSTEMFORCEDOWNLOADBOOT]{LP\_SYSTEM\_FORCE\_DOWNLOAD\_BOOT} and triggering a CPU reset. If this eFuse is 1, \hyperref[fielddesc:LPSYSTEMFORCEDOWNLOADBOOT]{LP\_SYSTEM\_FORCE\_DOWNLOAD\_BOOT} is disabled.
...
\hyperref[fielddesc:EFUSEDISUSBSERIALJTAGROMPRINT]{EFUSE\_DIS\_USB\_SERIAL\_JTAG\_ROM\_PRINT} controls the printing to \textbf{USB Serial/JTAG controller}. When this bit is 1, printing to USB Serial/JTAG controller is disabled. When this bit is 0, ROM messages can be printed to USB Serial/JTAG controller.
