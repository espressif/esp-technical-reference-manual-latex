...
ICM\_CPU\_ADDRHOLE\_INTR &  HP APM 检测到越权访问；或当主机为 USB 2.0 高速 OTG、USB 2.0 全速 OTG、EMAC、SDMMC、Trace0/1、GDMA-AHB、L2MEM 监测器和 SPM 监测器时，DMA APM 检测到越权访问 &  ICM\_SYS\_REG\_INT \\ \hline
...
\input{21-PERMCTRL/21-PERMCTRL-dma-pms-reg-summ__CN}
...
请查看章节 \hyperref[glossary-access-types]{\textit{寄存器的访问类型}}，了解“访问”列缩写的含义。
\input{21-PERMCTRL/21-PERMCTRL-hp-peri-pms-reg-summ__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-lp2hp-peri-pms-reg-summary__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-lp-peri-pms-reg-summary__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-hp2lp-peri-pms-reg-summary__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-dma-pms-reg__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-hp-peri-pms-reg__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-lp2hp-peri-pms-reg__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-lp-peri-pms-reg__CN}
...
\input{21-PERMCTRL/21-PERMCTRL-hp2lp-peri-pms-reg__CN}
