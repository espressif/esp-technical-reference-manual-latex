...
\textbf{Description}\\
This instruction performs a left shift on the four 32-bit data segments in the register \lstinline{qy} respectively. The left shift amount is the value in the 6-bit special register \lstinline{SAR}. During the shift process, the lower bits are padded with 0. The lower 32 bits of the shift result are stored in the corresponding data segment in the register \lstinline{qu}.\\
\textbf{Operation}
\begin{lstlisting}
