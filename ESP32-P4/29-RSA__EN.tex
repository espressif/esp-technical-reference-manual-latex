...
The RSA accelerator is activated by setting the \hyperref[fielddesc:HPSYSCLKRSTCRYPTORSACLKEN]{HP\_SYS\_CLKRST\_CRYPTO\_RSA\_CLK\_EN} bit in the \hyperref[regdesc:HPSYSCLKRSTPERICLKCTRL25REG]{HP\_SYS\_CLKRST\_PERI\_CLK\_CTRL25\_REG} register and clearing the \hyperref[fielddesc:HPSYSCLKRSTRSTENRSA]{HP\_SYS\_CLKRST\_RST\_EN\_RSA} bit in the \hyperref[regdesc:HPSYSCLKRSTHPRSTEN2REG]{HP\_SYS\_CLKRST\_HP\_RST\_EN2\_REG} register. Additionally, users also need to clear \hyperref[fielddesc:HPSYSCLKRSTRSTENDS]{HP\_SYS\_CLKRST\_RST\_EN\_DS} and \hyperref[fielddesc:HPSYSCLKRSTRSTENECDSA]{HP\_SYS\_CLKRST\_RST\_EN\_ECDSA}  bits to reset the \nameref{mod:digsig} and the \nameref{mod:ecdsa} accelerators.
