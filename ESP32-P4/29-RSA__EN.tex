...
\begin{itemize}
    \item Large-number modular exponentiation with two additional acceleration options to further increase the calculation speed
...
The RSA accelerator is activated by setting the \hyperref[fielddesc:HPSYSCLKRSTREGCRYPTORSACLKEN]{HP\_SYS\_CLKRST\_REG\_CRYPTO\_RSA\_CLK\_EN} bit in the \hyperref[regdesc:HPSYSCLKRSTPERICLKCTRL25REG]{HP\_SYS\_CLKRST\_PERI\_CLK\_CTRL25\_REG} register and clearing the \hyperref[fielddesc:HPSYSCLKRSTREGRSTENRSA]{HP\_SYS\_CLKRST\_REG\_RST\_EN\_RSA} bit in the \hyperref[regdesc:HPSYSCLKRSTHPRSTEN2REG]{HP\_SYS\_CLKRST\_HP\_RST\_EN2\_REG} register. Additionally, users also need to clear \hyperref[fielddesc:HPSYSCLKRSTREGRSTENDS]{HP\_SYS\_CLKRST\_REG\_RST\_EN\_DS} and \hyperref[fielddesc:HPSYSCLKRSTREGRSTENECDSA]{HP\_SYS\_CLKRST\_REG\_RST\_EN\_ECDSA}  bits to reset the \nameref{mod:digsig} and the \nameref{mod:ecdsa} accelerators.
...
\vspace{-0.5em}
    ...
    \chipname{}'s \nameref{mod:digsig} and \nameref{mod:ecdsa} modules also call the RSA accelerator when working. Therefore, users cannot access the RSA accelerator when the \nameref{mod:digsig} or the \nameref{mod:ecdsa} module is working.%
}
...
\begin{longtable}{ | l | l | r | }
    ...
    Accelerated     & No acceleration   & $1.023 \times 10^6$   \\ \hline
