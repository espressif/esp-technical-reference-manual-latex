...
\begin{regdesc}
\begin{reglist}
\item [INT\_ENABLE\lbrack\regindex{n}\rbrack] Configures whether to enable assertion of the \regindex{n}th external interrupt to the CPU. \\
0: Disable\\
1: Enable\\
(R/W)
\end{reglist}
...
\begin{regdesc}
\begin{reglist}
\item [INT\_TYPE\lbrack\regindex{n}\rbrack] Configures whether to enable capturing the rising edge of the \regindex{n}th external interrupt.\\
