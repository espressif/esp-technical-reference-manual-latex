...
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSLPMMHPUSBOTGALLOW}\item [PMS\_LP\_MM\_HP\_USBOTG\_ALLOW] 配置 LP CPU 在机器模式下是否有权限访问 USB 2.0 高速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSLPMMHPUSBOTG11ALLOW}\item [PMS\_LP\_MM\_HP\_USBOTG11\_ALLOW] 配置 LP CPU 在机器模式下是否有权限访问 USB 2.0 全速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSLPMMHPUSBOTG11WRAPALLOW}\item [PMS\_LP\_MM\_HP\_USBOTG11\_WRAP\_ALLOW] 配置 LP CPU 在机器模式下是否有权限访问 USB 2.0 全速 OTG wrap。\\
0：无权限 \\
1：有权限 \\ (R/W)
...
\label{fielddesc:PMSLPMMHPUSBPHYALLOW}\item [PMS\_LP\_MM\_HP\_USB\_PHY\_ALLOW] 配置 LP CPU 在机器模式下是否有权限访问 USB 2.0 高速 OTG PHY。\\
0：无权限 \\
1：有权限 \\ (R/W)
