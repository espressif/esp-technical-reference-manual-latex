...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAGDMACHNRPMS}\item [PMS\_DMA\_GDMA\_CH\regindex{n}\_R\_PMS] 配置 VDMA ch\regindex{n} 读 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭读权限。\\
1：使能读权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAGDMACHNWPMS}\item [PMS\_DMA\_GDMA\_CH\regindex{n}\_W\_PMS] 配置 VDMA ch\regindex{n} 写 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭写权限。\\
1：使能写权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAUSBRPMS}\item [PMS\_DMA\_USB\_R\_PMS] 配置 USB 2.0 高速 OTG 读 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭读权限。\\
1：使能读权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAUSBWPMS}\item [PMS\_DMA\_USB\_W\_PMS] 配置 USB 2.0 高速 OTG 写 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭写权限。\\
1：使能写权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAUSBOTG11RPMS}\item [PMS\_DMA\_USBOTG11\_R\_PMS] 配置 USB 2.0 全速 OTG 读 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭读权限。\\
1：使能读权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSDMAUSBOTG11WPMS}\item [PMS\_DMA\_USBOTG11\_W\_PMS] 配置 USB 2.0 全速 OTG 写 32 个地址区间的权限。bit0 对应地址区间 0，以此类推。\\
0：关闭写权限。\\
1：使能写权限。\\ (R/W)
\end{reglist}\end{regdesc}
\end{register}
