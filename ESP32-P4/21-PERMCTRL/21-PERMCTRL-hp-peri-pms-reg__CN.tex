...
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSCORENMMHPUSBOTGALLOW}\item [PMS\_CORE\regindex{n}\_MM\_HP\_USBOTG\_ALLOW] 配置 HP CPU\regindex{n} 在机器模式下是否有权限访问 USB 2.0 高速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSCORENMMHPUSBOTG11ALLOW}\item [PMS\_CORE\regindex{n}\_MM\_HP\_USBOTG11\_ALLOW] 配置 HP CPU\regindex{n} 在机器模式下是否有权限访问 USB 2.0 全速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSCORENMMHPUSBOTG11WRAPALLOW}\item [PMS\_CORE\regindex{n}\_MM\_HP\_USBOTG11\_WRAP\_ALLOW] 配置 HP CPU\regindex{n} 在机器模式下是否有权限访问 USB 2.0 全速 OTG wrap。\\
0：无权限 \\
1：有权限 \\ (R/W)
...
0：无权限 \\
1：有权限\\ (R/W)
\label{fielddesc:PMSCORENMMHPUSBPHYALLOW}\item [PMS\_CORE\regindex{n}\_MM\_HP\_USB\_PHY\_ALLOW] 配置 HP CPU\regindex{n} 在机器模式下是否有权限访问 USB 2.0 高速 OTG PHY。\\
0：无权限 \\
1：有权限 \\ (R/W)
...
\begin{regdesc}\begin{reglist}
\label{fielddesc:PMSCORENUMHPUSBOTGALLOW}\item [PMS\_CORE\regindex{n}\_UM\_HP\_USBOTG\_ALLOW] 配置 HP CPU\regindex{n} 在用户模式下是否有权限访问 USB 2.0 高速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSCORENUMHPUSBOTG11ALLOW}\item [PMS\_CORE\regindex{n}\_UM\_HP\_USBOTG11\_ALLOW] 配置 HP CPU\regindex{n} 在用户模式下是否有权限访问 USB 2.0 全速 OTG。\\
0：无权限 \\
1：有权限 \\ (R/W)
\label{fielddesc:PMSCORENUMHPUSBOTG11WRAPALLOW}\item [PMS\_CORE\regindex{n}\_UM\_HP\_USBOTG11\_WRAP\_ALLOW] 配置 HP CPU\regindex{n} 在用户模式下是否有权限访问 USB 2.0 全速 OTG wrap。\\
0：无权限 \\
1：有权限 \\ (R/W)
...
\label{fielddesc:PMSCORENUMHPUSBPHYALLOW}\item [PMS\_CORE\regindex{n}\_UM\_HP\_USB\_PHY\_ALLOW] 配置 HP CPU\regindex{n} 在用户模式下是否有权限访问 USB 2.0 高速 OTG PHY。\\
0：无权限 \\
1：有权限 \\ (R/W)
