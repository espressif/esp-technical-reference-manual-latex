...
The AES accelerator is activated by setting the \hyperref[fielddesc:HPSYSCLKRSTCRYPTOAESCLKEN]{HP\_SYS\_CLKRST\_CRYPTO\_AES\_CLK\_EN} bit in the \hyperref[regdesc:HPSYSCLKRSTPERICLKCTRL25REG]{HP\_SYS\_CLKRST\_PERI\_CLK\_CTRL25\_REG} register and clearing the \hyperref[fielddesc:HPSYSCLKRSTRSTENAES]{HP\_SYS\_CLKRST\_RST\_EN\_AES} bit in the \hyperref[regdesc:HPSYSCLKRSTHPRSTEN2REG]{HP\_SYS\_CLKRST\_HP\_RST\_EN2\_REG} register. Besides, due to resource reuse between cryptography accelerator modules, users also need to additionally clear the \hyperref[fielddesc:HPSYSCLKRSTRSTENDS]{HP\_SYS\_CLKRST\_RST\_EN\_DS} bit and the \hyperref[fielddesc:HPSYSCLKRSTRSTENKM]{HP\_SYS\_CLKRST\_RST\_EN\_KM} bit in the \hyperref[regdesc:HPSYSCLKRSTHPRSTEN2REG]{HP\_SYS\_CLKRST\_HP\_RST\_EN2\_REG} register.
