...
\begin{figure}[ht!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/Bit_Fields__EN}}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{\modulefiles/figures/Fields_of_an_Error_Frame__EN}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{\modulefiles/figures/Overload_frames__EN}}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{\modulefiles/figures/Fields_within_an_Interframe_Space__EN}}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{\modulefiles/figures/TWAI_BIT_TIMING_20190625__EN}}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/TWAI_Overview_Diagram_20190628__EN}}
    \caption{TWAI Overview Diagram}
    \label{Figure:TWAI Overview Diagram}
\end{figure}

The ESP32-S2 contains a TWAI Controller. Figure \ref{Figure:TWAI Overview Diagram} shows the major functional blocks of the TWAI Controller.
...
Note that the Transmit Buffer registers, Receive Buffer registers, and the Acceptance Filter registers share the same address range (offset \hexprefix{}0040 to \hexprefix{}0070). Their access is governed by the following rules:
...
The ESP32-S2 TWAI controller has two working modes: Reset Mode and Operation Mode. Reset Mode and Operation Mode are entered by setting the \hyperref[fielddesc:TWAIRESETMODE]{TWAI\_RESET\_MODE} bit to 1 or 0 respectively.
...
\caption{Bit Information of \hyperref[regdesc:TWAICLOCKDIVIDERREG]{TWAI\_CLOCK\_DIVIDER\_REG}; TWAI Address \hexprefix{}18}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{Bit Information of \hyperref[regdesc:TWAIBUSTIMING1REG]{TWAI\_BUS\_TIMING\_1\_REG}; TWAI Address \hexprefix{}1c}
...
\endhead
\endfoot
\hexprefix{}40&TX/RX frame information&\hexprefix{}40&TX/RX frame information\\\hline
...
\hexprefix{}6c&\cellcolor{yellow}{reserved}&\hexprefix{}6c&TX/RX data byte 7\\\hline
\hexprefix{}70&\cellcolor{yellow}{reserved}&\hexprefix{}70&TX/RX data byte 8\\\hline
\end{longtable}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Frame Information (SFF/EFF)；TWAI Address \hexprefix{}40}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 1 (SFF); TWAI Address \hexprefix{}44}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 2 (SFF); TWAI Address \hexprefix{}48}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 1 (EFF); TWAI Address \hexprefix{}44}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 2 (EFF); TWAI Address \hexprefix{}48}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 3 (EFF); TWAI Address \hexprefix{}4c}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{TX/RX Identifier 4 (EFF); TWAI Address \hexprefix{}50}
...
\begin{itemize}
    \item Whatever free space is left in the Receive FIFO is filled with the partial contents of the overrun message. If the Receive FIFO is already full, then none of the overrun message’s contents will be stored.
    \item On the first message that causes the Receive FIFO to overrun, a Data Overrun Interrupt will be triggered.
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/Acceptance filter__EN}}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/Single Filter Mode__EN}}
...
\begin{figure}[ht!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/Dual Filter Mode__EN}}
...
\begin{figure}[ht!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{\modulefiles/figures/Error_State_Transition_20190625__EN}}
...
\begin{longtable}[c]{|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|}
    \caption{Bit Information of \hyperref[regdesc:TWAIERRCODECAPREG]{TWAI\_ERR\_CODE\_CAP\_REG}; TWAI Address \hexprefix{}30}
...
\begin{longtable}[c]{|p{2.3cm}|p{2.3cm}|p{2.3cm}|p{2.3cm}|p{2.3cm}|p{2.3cm}|}
    \caption{Bit Information of \hyperref[regdesc:TWAIARB LOST CAPREG]{TWAI\_ARB LOST CAP\_REG}; TWAI Address \hexprefix{}2c}
    \label{table:ALC_REG}
    \\\hline
    \rowcolor{lightgray}
...
\begin{figure}[ht!]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{\modulefiles/figures/Positions_of_Arbitration_Lost_Bits_20190625__EN}}
...
Users can access the TWAI with two base addresses, which can be seen in the following table. For more information about accessing peripherals from different buses please see Chapter: \ref{mod:sysmem} \textit{\nameref{mod:sysmem}}.

\begin{longtable}[c]{ | l | C{3cm} | }
\caption{TWAI Base Address} \label{table:TBD-PERIPHERAL-NAME-Base-Addresses}
\\ \hline
\rowcolor{lightgray}
...
\subfile{\modulefiles/twai-reg-summ__EN}

\section{Register Description}
\label{chapter:Register_Description}
\subfile{\modulefiles/twai-reg__EN}
\end{document}
