...
\subfileinclude{05-IOMUXGPIO__EN}
\subfileinclude{06-RESCLK__EN}
\subfileinclude{07-BOOTCTRL__EN}
\subfileinclude{08-INTMTRX__EN}
\subfileinclude{09-LOWPOWM__EN}
\subfileinclude{10-SYSTIMER__EN}
\subfileinclude{11-TIMG__EN}
\subfileinclude{12-WDT__EN}
\subfileinclude{13-XTWDT__EN}
\subfileinclude{14-PERMCTRL__EN}
\subfileinclude{15-SYSREG__EN}


\part{Cryptography/Security Component}

Dedicated to security features, this part explores cryptographic accelerators like SHA and AES. It also covers RSA digital signatures, random number generation, and encryption/decryption algorithms, showcasing the SoC's capabilities in cryptography and secure data processing.

\subfileinclude{16-SHA__EN}
\subfileinclude{17-AES__EN}
\subfileinclude{18-RSA__EN}
\subfileinclude{19-HMAC__EN}
\subfileinclude{20-DIGSIG__EN}
\subfileinclude{21-EXTMEMENCR__EN}
\subfileinclude{22-RNG__EN}
...
\subfileinclude{23-UART__EN}
\subfileinclude{24-SPI__EN}
\subfileinclude{25-I2C__EN}
\subfileinclude{26-I2S__EN}
\subfileinclude{27-PCNT__EN}
\subfileinclude{28-USBOTG__EN}
\subfileinclude{29-TWAI__EN}
\subfileinclude{30-LEDPWM__EN}
\subfileinclude{31-RMT__EN}
