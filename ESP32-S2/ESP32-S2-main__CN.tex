...
\subfileinclude{05-IOMUXGPIO__CN}
\subfileinclude{06-RESCLK__CN}
\subfileinclude{07-BOOTCTRL__CN}
\subfileinclude{08-INTMTRX__CN}
\subfileinclude{09-LOWPOWM__CN}
\subfileinclude{10-SYSTIMER__CN}
\subfileinclude{11-TIMG__CN}
\subfileinclude{12-WDT__CN}
\subfileinclude{13-XTWDT__CN}
\subfileinclude{14-PERMCTRL__CN}
\subfileinclude{15-SYSREG__CN}


\part{加密和安全组件}

该部分专门介绍芯片的安全功能，包括 SHA、AES 等加密加速器，RSA 数字签名、随机数生成、加密/解密算法等安全特性，展示了芯片在加密和安全数据处理方面的性能。

\subfileinclude{16-SHA__CN}
\subfileinclude{17-AES__CN}
\subfileinclude{18-RSA__CN}
\subfileinclude{19-HMAC__CN}
\subfileinclude{20-DIGSIG__CN}
\subfileinclude{21-EXTMEMENCR__CN}
\subfileinclude{22-RNG__CN}
...
\subfileinclude{23-UART__CN}
\subfileinclude{24-SPI__CN}
\subfileinclude{25-I2C__CN}
\subfileinclude{26-I2S__CN}
\subfileinclude{27-PCNT__CN}
\subfileinclude{28-USBOTG__CN}
\subfileinclude{29-TWAI__CN}
\subfileinclude{30-LEDPWM__CN}
\subfileinclude{31-RMT__CN}
