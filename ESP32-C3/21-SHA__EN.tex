...
However, \chipname{} SHA also supports optional ``interleaved" message digest calculation. Users can insert new calculation (both Typical SHA and DMA-SHA) each time the SHA accelerator completes a sequence of operations.
\begin{itemize}
...
\subfile{\modulefiles/21-SHA-reg-summ__EN}
...
\subfile{\modulefiles/21-SHA-reg__EN}
