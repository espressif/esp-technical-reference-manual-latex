...
\begin{longtable}[c]{|*{6}{l|C{4cm}|C{3.5cm}|C{9.4cm}|p{0.3cm}|C{5.3cm}|}}
    ...
    \cline{5-6}
    \rowcolor{gray!25}
    \multirow{-2}*{\textbf{No.}} & \multirow{-2}*{\textbf{Chapter}} & \multirow{-2}*{\textbf{Source}} & \multirow{-2}*{\textbf{Configuration Register}} & \textbf{Bit} & \textbf{Name} \\
    \hline
    \endfirsthead
...
0 & reserved & reserved & reserved & 0 & \multirow{32}*{\makecell{\hyperref[regdesc:INTERRUPTCORE0INTRSTATUS0REG]{INTERRUPT\_CORE0\_INTR\_STATUS\_0\_REG}}}                        	\\
    \cline{1-5}                                           
