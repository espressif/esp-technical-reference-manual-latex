...
\begin{itemize}
    ...
    when bit HP\_SYS\_ENABLE\_DOWNLOAD\_G0CB\_DECRYPT in register\\ HP\_SYS\_EXTERNAL\_DEVICE\_ENCRYPT\_DECRYPT\_CONTROL\_REG is 1, the Auto Decryption block can be enabled. Otherwise, it is not operational.
