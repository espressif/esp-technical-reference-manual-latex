...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOOUTDATAORIG}\item [GPIO\_OUT\_DATA\_ORIG] 配置简单输出模式下 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出值。\\
0：低电平\\
1：高电平\\ 
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 的值分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出值。\\
(R/W/SC/WTC)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOOUTW1TS}\item [GPIO\_OUT\_W1TS] 配置是否置位 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出寄存器 \hyperref[regdesc:GPIOOUTREG]{GPIO\_OUT\_REG}。\\
0：不置位\\
1：\hyperref[regdesc:GPIOOUTREG]{GPIO\_OUT\_REG} 中相应位也将置 1\\
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28。\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOOUTW1TC}\item [GPIO\_OUT\_W1TC] 配置是否清零 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出寄存器 \hyperref[regdesc:GPIOOUTREG]{GPIO\_OUT\_REG}。\\ 
0：不清零\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOENABLEDATA}\item [GPIO\_ENABLE\_DATA] 配置是否使能 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 输出。\\
0：不使能\\
1：使能\\ 
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28。\\(R/W/WTC)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOENABLEW1TS}\item [GPIO\_ENABLE\_W1TS] 配置是否置位 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出使能寄存器 \hyperref[regdesc:GPIOENABLEREG]{GPIO\_ENABLE\_REG}。\\
0：不置位\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOENABLEW1TC}\item [GPIO\_ENABLE\_W1TC] 配置是否清零 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输出使能寄存器 \hyperref[regdesc:GPIOENABLEREG]{GPIO\_ENABLE\_REG}。\\
0：不清零\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOINDATANEXT}\item [GPIO\_IN\_DATA\_NEXT] 表示 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的输入值。\\
每一位均代表一个管脚的输入值：\\
0：低电平\\
1：高电平\\ 
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28。\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOPROCPUINT}\item [GPIO\_PROCPU\_INT] 表示 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的 CPU 中断状态。\\ 
每位代表：\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOSDIOINT}\item [GPIO\_SDIO\_INT] 表示 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的 GPIO\_SDIO\_INT 中断状态。\\ 
每位代表：\\
...
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28。\\
如果 \hyperref[regdesc:GPIOPINNREG]{GPIO\_PIN\regindex{n}\_REG} 中 bit[15] 高电平有效，即使能 GPIO\_SDIO\_INT 中断，则此寄存器所示的中断状态应与 \hyperref[regdesc:GPIOSTATUSREG]{GPIO\_STATUS\_REG} 中相应位的中断状态一致。 \\ (RO)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOSTATUSINTERRUPT}\item [GPIO\_STATUS\_INTERRUPT] GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的中断状态寄存器，软件可配置该寄存器的值。\\
bit[0]$\sim$bit[14] 和 bit[23]$\sim$bit[28] 分别对应 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28。\\
每一位均代表对应 GPIO 的中断状态：\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOSTATUSW1TS}\item [GPIO\_STATUS\_W1TS] 配置是否置位 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的中断状态寄存器 \hyperref[fielddesc:GPIOSTATUSINTERRUPT]{GPIO\_STATUS\_INTERRUPT}。\\
每一位的值可以为：\\
0：不置位\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOSTATUSW1TC}\item [GPIO\_STATUS\_W1TC] 配置是否清零 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的中断状态寄存器 \hyperref[fielddesc:GPIOSTATUSINTERRUPT]{GPIO\_STATUS\_INTERRUPT}。\\
每一位的值可以为：\\
0：不清零\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOSTATUSINTERRUPTNEXT}\item [GPIO\_STATUS\_INTERRUPT\_NEXT] 表示 GPIO0$\sim$GPIO14 和 GPIO23$\sim$GPIO28 的中断源信号。\\
每位代表：\\
...
\begin{register}{H}{GPIO\_PIN\regindex{n}\_REG (\regindex{n}: 0-14, 23-28)}{0x00D4+0x4*\regindex{n}}\label{regdesc:GPIOPINNREG}
...
\begin{register}{H}{GPIO\_PIN\regindex{n}\_REG (\regindex{n}: 0-14, 23-28)}{0x00D4+0x4*\regindex{n}}
\begin{regdesc}\begin{reglist}
\item [接上页]
\label{fielddesc:GPIOPINNINTENA}\item [GPIO\_PIN\regindex{n}\_INT\_ENA] 配置是否使能 CPU 中断或 CPU 非屏蔽中断。\\
- bit[13]：配置是否使能 CPU 中断：\\
    0：不使能\\
    1：使能\\
- bit[14]：无效\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNCNINSEL}\item [GPIO\_FUNC\regindex{m}\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 \regindex{m}。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNCPINSEL}\item [GPIO\_FUNC\regindex{p}\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 \regindex{p}。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNCRINSEL}\item [GPIO\_FUNC\regindex{r}\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 \regindex{r}。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNC70INSEL}\item [GPIO\_FUNC70\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 70。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
...
0x40：选择恒高电平输入\\
0x60：选择恒低电平输入\\ (R/W)
\label{fielddesc:GPIOFUNC70ININVSEL}\item [GPIO\_FUNC70\_IN\_INV\_SEL] 配置是否反转输入值。\\
0：不反转\\
1：反转\\ (R/W)
\label{fielddesc:GPIOSIG70INSEL}\item [GPIO\_SIG70\_IN\_SEL] 配置是否通过 HP GPIO 交换矩阵连接信号。\\
0：旁路 HP GPIO 交换矩阵，即直接通过 HP IO MUX 连接信号与外设\\
1：通过 HP GPIO 交换矩阵连接信号与外设\\
 (R/W)
\end{reglist}\end{regdesc}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNCTINSEL}\item [GPIO\_FUNC\regindex{t}\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 \regindex{t}。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:GPIOFUNCUINSEL}\item [GPIO\_FUNC\regindex{u}\_IN\_SEL] 配置从 21 个 GPIO 中选择一个管脚连接输入信号 \regindex{u}。\\
0x0：选择 GPIO0\\
0x1：选择 GPIO1\\
......\\
0x1B：选择 GPIO27\\
