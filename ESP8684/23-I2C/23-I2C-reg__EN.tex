...
\label{fielddesc:I2CSCLLOWPERIOD}\item [I2C\_SCL\_LOW\_PERIOD] This field is used to configure how long SCL remains low, in I2C module clock cycles. (R/W)
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CSCLHIGHPERIOD}\item [I2C\_SCL\_HIGH\_PERIOD] This field is used to configure how long SCL remains high, in I2C module clock cycles. (R/W)
\label{fielddesc:I2CSCLWAITHIGHPERIOD}\item [I2C\_SCL\_WAIT\_HIGH\_PERIOD] This field is used to configure the SCL\_FSM's waiting period for SCL high level, in I2C module clock cycles. (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CMSMODE}\item [I2C\_MS\_MODE] Set this bit to configure the I2C master controller as an I2C Master. Clear this bit to make the I2C master controller non-operational. (R/W)
...
\regfield{I2C\_TXFIFO\_WM\_THRHD}{4}{5}{{0x2}}%
\regfield{(reserved)}{1}{4}{0}%
\regfield{I2C\_RXFIFO\_WM\_THRHD}{4}{0}{{0x6}}%
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CRXFIFOWMTHRHD}\item [I2C\_RXFIFO\_WM\_THRHD] The watermark threshold of RX FIFO in non-FIFO mode. When I2C\_FIFO\_PRT\_EN is 1 and RX FIFO counter is bigger than I2C\_RXFIFO\_WM\_THRHD[3:0], I2C\_RXFIFO\_WM\_INT\_RAW bit is valid. (R/W)
\label{fielddesc:I2CTXFIFOWMTHRHD}\item [I2C\_TXFIFO\_WM\_THRHD] The watermark threshold of TX FIFO in non-FIFO mode. When I2C\_FIFO\_PRT\_EN is 1 and TX FIFO counter is smaller than I2C\_TXFIFO\_WM\_THRHD[3:0], I2C\_TXFIFO\_WM\_INT\_RAW bit is valid. (R/W)
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CSCLFILTERTHRES}\item [I2C\_SCL\_FILTER\_THRES] When a pulse on the SCL input has smaller width than the value of this field in I2C module clock cycles, the I2C master controller ignores that pulse. (R/W)
\label{fielddesc:I2CSDAFILTERTHRES}\item [I2C\_SDA\_FILTER\_THRES] When a pulse on the SDA input has smaller width than the value of this field in I2C module clock cycles, the I2C master controller ignores that pulse. (R/W)
...
\begin{register}{H}{I2C\_CLK\_CONF\_REG}{0x0054}\label{regdesc:I2CCLKCONFREG}
...
\label{fielddesc:I2CSCLKSEL}\item [I2C\_SCLK\_SEL] The clock selection bit for the I2C master controller. 0: XTAL\_CLK; 1: RC\_FAST\_CLK. (R/W)
\label{fielddesc:I2CSCLKACTIVE}\item [I2C\_SCLK\_ACTIVE] The clock switch bit for the I2C master controller. (R/W)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CSCLRSTSLVNUM}\item [I2C\_SCL\_RST\_SLV\_NUM] Configures the pulses of SCL generated. Valid when I2C\_SCL\_RST\_SLV\_EN is 1. (R/W)
...
\regfield{I2C\_TXFIFO\_CNT}{5}{18}{{0}}%
\regfield{(reserved)}{5}{13}{00000}%
\regfield{I2C\_RXFIFO\_CNT}{5}{8}{{0}}%
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CRESPREC}\item [I2C\_RESP\_REC] The received ACK value. 0: ACK; 1: NACK. (RO)
\label{fielddesc:I2CARBLOST}\item [I2C\_ARB\_LOST] When the I2C master controller loses control of the SCL line, this bit changes to 1. (RO)
...
\regfield{I2C\_TXFIFO\_WADDR}{4}{15}{{0}}%
\regfield{(reserved)}{1}{14}{0}%
\regfield{I2C\_TXFIFO\_RADDR}{4}{10}{{0}}%
\regfield{(reserved)}{1}{9}{0}%
\regfield{I2C\_RXFIFO\_WADDR}{4}{5}{{0}}%
\regfield{(reserved)}{1}{4}{0}%
\regfield{I2C\_RXFIFO\_RADDR}{4}{0}{{0}}%
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CRXFIFORADDR}\item [I2C\_RXFIFO\_RADDR] This is the offset address of the APB reading from RX FIFO. (RO)
\label{fielddesc:I2CRXFIFOWADDR}\item [I2C\_RXFIFO\_WADDR] This is the offset address of the I2C master controller receiving data and writing to RX FIFO. (RO)
\label{fielddesc:I2CTXFIFORADDR}\item [I2C\_TXFIFO\_RADDR] This is the offset address of the I2C master controller reading from TX FIFO. (RO)
...
\end{itemize} (R/W)
\label{fielddesc:I2CCOMMAND0DONE}\item [I2C\_COMMAND0\_DONE] When command 0 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND1DONE}\item [I2C\_COMMAND1\_DONE] When command 1 has been executed, this bit changes to high
level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND2DONE}\item [I2C\_COMMAND2\_DONE] When command 2 has been executed, this bit changes to high
Level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND3DONE}\item [I2C\_COMMAND3\_DONE] When command 3 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND4DONE}\item [I2C\_COMMAND4\_DONE] When command 4 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND5DONE}\item [I2C\_COMMAND5\_DONE] When command 5 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND6DONE}\item [I2C\_COMMAND6\_DONE] When command 6 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\label{fielddesc:I2CCOMMAND7DONE}\item [I2C\_COMMAND7\_DONE] When command 7 has been executed, this bit changes to high level. (R/W/SS)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CTXFIFOSTARTADDR}\item [I2C\_TXFIFO\_START\_ADDR] This is the start address of I2C TX FIFO. (HRO)
\end{reglist}\end{regdesc}
\end{register}
...
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
\label{fielddesc:I2CRXFIFOSTARTADDR}\item [I2C\_RXFIFO\_START\_ADDR] This is the start address of I2C RX FIFO. (HRO)
\end{reglist}\end{regdesc}
\end{register}

\begin{register}{H}{I2C\_DATE\_REG}{0x00F8}\label{regdesc:I2CDATEREG}
\regfield{I2C\_DATE}{32}{0}{{0x20070201}}%
\reglabel{Reset}\regnewline%
\begin{regdesc}\begin{reglist}
