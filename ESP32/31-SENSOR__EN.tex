...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{./31-SENSOR/figures/touchsensor2.eps}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{./31-SENSOR/figures/Touch_Sensor.eps}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{./31-SENSOR/figures/Touch_Sensor2.eps}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{./31-SENSOR/figures/touch_fsm.eps}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.65\textwidth]{./31-SENSOR/figures/saradc.eps}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{./31-SENSOR/figures/saradc_mux.eps}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{./31-SENSOR/figures/saradc_rtc_ctrl.eps}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{./31-SENSOR/figures/dac.eps}}
...
\vspace{-2em}
\begin{itemize}
    \item The cosine waveform generator uses an internal counter to control the waveform period. This counter is not accessible to software. If \hyperref[regdesc:SENSSARDACCTRL1REG]{SENS\_SAR\_SW\_FSTEP} is decreased while the generator is enabled, and the current counter value is already greater than the new FSTEP, the counter must overflow before it can restart from 0 at the new frequency. During that time, the waveform timing may be incorrect.
    \item When adjusting the frequency dynamically, clear \hyperref[regdesc:SENSSARDACCTRL1REG]{SENS\_SW\_TONE\_EN} to disable the generator, write the new FSTEP, then set \hyperref[regdesc:SENSSARDACCTRL1REG]{SENS\_SW\_TONE\_EN} again so that the counter restarts from 0.
\end{itemize}
\end{tiplisting}

\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{./31-SENSOR/figures/dac2.eps}}
