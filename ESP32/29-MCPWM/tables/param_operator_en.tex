...
\label{table:para_sub_operator}
    \\\hline
    \rowcolor{lightgray}
   Submodule & Configuration Parameter or Option \\ \hline 
...
\endfoot
    ...
    \begin{itemize}
        ...
        \begin{itemize}
           \item Switch high or low PWM\textcolor{red}{\it{x}}A and/or PWM\textcolor{red}{\it{x}}B outputs
        ...
        \item Add a dead time to raising and / or failing edge on PWM outputs.
