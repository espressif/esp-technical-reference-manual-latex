...
\label{fielddesc:GPIOFUNCNOENSEL} \item [GPIO\_FUNC\textcolor{red}{\it{n}}\_OEN\_SEL]1：强制从 GPIO\_ENABLE\_REG bit \textcolor{red}{\it{n}} 中选取输出使能信号。0：使用从外设选取的输出使能信号。（读/写）
