...
\phantomsection
\section*{相关文档和资源}\label{sec:resources}
\lhead{\it{相关文档和资源}}
\rhead{}
\ifthenelse{\equal{\docprojtype}{trm}}{
  \addcontentsline{toc}{chapter}{相关文档和资源}
}{
  \addcontentsline{toc}{section}{相关文档和资源}
}
...
% Include this link only if it is defined in resources-link-defs.tex
  ...
  \ifcsname linktrmlatexsourcerepo\endcsname%
    \item 技术参考手册 LaTeX 源码 --
        {\small 乐鑫芯片技术参考手册 LaTeX 源码的公开仓库。}\\
...
\begin{itemize}
  ...
  \fi%
    ...
    \item \textit{ESP-FAQ} --
        {\small 由乐鑫官方推出的针对常见问题的总结。}\\
        \href{\linkprefix\linkespfaqCN}{\linkprefix\linkespfaqCN}
...
\begin{itemize}
    ...
    \iftagged{ESP32-P4}{}{\item \chipseries{} 系列模组 --
