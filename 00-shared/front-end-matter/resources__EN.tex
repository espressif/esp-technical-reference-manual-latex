...
\phantomsection
\section*{Related Documentation and Resources}\label{sec:resources}
\lhead{\it{Related Documentation and Resources}}
\rhead{}
\ifthenelse{\equal{\docprojtype}{trm}}{
  \addcontentsline{toc}{chapter}{Related Documentation and Resources}
}{
  \addcontentsline{toc}{section}{Related Documentation and Resources}
}
...
\begin{itemize}
  ...
  \ifcsname linktrmlatexsourcerepo\endcsname%
    \item \textit{Technical Reference Manual LaTeX sources} --
        {\small Public repository containing the LaTeX sources for Espressif chip TRMs.}\\
        \href{\linkprefix\linktrmlatexsourcerepo}{\linkprefix\linktrmlatexsourcerepo}
  \fi%
...
\begin{itemize}
  ...
  \fi%
    ...
    \item \textit{ESP-FAQ} --
        {\small A summary document of frequently asked questions released by Espressif.}\\
        \href{\linkprefix\linkespfaqEN}{\linkprefix\linkespfaqEN}
...
\begin{itemize}
    ...
    \iftagged{ESP32-P4}{}{\item \textit{\chipseries{} Series Modules} --
